...
def get_blocks(num_layers):
    if num_layers == 50:
        ...
        print("ArcFace ResNet error, 50 or 100 layers available")
        blocks = None
    return blocks
...
class Backbone(Module):
    def __init__(self, num_layers, drop_ratio, mode='ir_se'):
        ...
        assert num_layers in [50,100], 'num_layers should be 50 or 100'
        assert mode in ['ir_se','ir'], 'mode should be ir or ir_se'
